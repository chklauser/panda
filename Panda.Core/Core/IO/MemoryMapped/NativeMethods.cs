...
namespace Panda.Core.IO.MemoryMapped
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance",
        ...
        Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
    [StructLayout(LayoutKind.Sequential)]
    public struct FILE_ZERO_DATA_INFORMATION
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields", Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
        public Int64 FileOffset;
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields", Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
        public Int64 BeyondFinalZero;
    }

    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1815:OverrideEqualsAndOperatorEqualsOnValueTypes", Justification = "Mirrors native struct, only used to transfer data to and from native APIs"), 
    System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance",
        "CA1815:OverrideEqualsAndOperatorEqualsOnValueTypes",
        Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
    [StructLayout(LayoutKind.Sequential)]
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1028:EnumStorageShouldBeInt32", Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
    [Flags]
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2217:DoNotMarkEnumsWithFlags", Justification = "E_IO_CONTROL_CODE values are defined by the windows API. We are not in control of which values/bits make sense."), 
    System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1028:EnumStorageShouldBeInt32", Justification = "Mirrors native struct, only used to transfer data to and from native APIs")]
    [Flags]
    public enum EIoControlCodes : uint
    {
        ChangerBase = 0x30,
